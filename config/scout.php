    ...
    */
    ...
    'meilisearch' => [
        ...
        'index-settings' => [
            ...
            'orphan_sponsorships' => [
                'filterableAttributes' => ['__soft_deleted', 'id', 'medical_sponsorship', 'university_scholarship', 'association_trips', 'summer_camp', 'orphan.academic_achievement.academic_year', 'orphan.academic_achievement.academic_level.id', 'orphan.academic_achievement.last_year_average', 'orphan.gender', 'orphan.birth_date', 'orphan.shoes_size', 'orphan.shirt_size', 'orphan.pants_size',
