    ...
    'meilisearch' => [
        ...
        'index-settings' => [
            ...
            'families' => [
                ...
                'filterableAttributes' => ['id', 'name', 'file_number', 'start_date', 'address.zone.name', 'tenant_id', 'branch.id', 'family_sponsorships.monthly_allowance', 'family_sponsorships.ramadan_basket', 'family_sponsorships.zakat', 'family_sponsorships.housing_assistance', 'family_sponsorships.eid_el_adha', 'orphans_count'],
