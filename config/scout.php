...
return [
    ...
    */
    ...
    'meilisearch' => [
        ...
        'index-settings' => [
            'users' => [
                'filterableAttributes' => ['__soft_deleted', 'id', 'name', 'email', 'phone', 'tenant_id', 'gender'],
                'searchableAttributes' => ['name', 'email', 'phone', 'gender'],
                'sortableAttributes' => ['name', 'email', 'phone', 'gender', 'created_at'],
            ],
            'roles' => [
                'filterableAttributes' => ['__soft_deleted', 'uuid', 'name', 'tenant_id'],
            ...
            'needs' => [
                'filterableAttributes' => ['__soft_deleted', 'id', 'needable.name', 'needable.type', 'status', 'tenant_id'],
            ...
            'family_sponsorships' => [
                'filterableAttributes' => ['__soft_deleted', 'id', 'monthly_allowance', 'ramadan_basket', 'zakat', 'housing_assistance', 'eid_al_adha', 'tenant_id', 'family.branch.id', 'family.zone.id', 'family.orphans_count', 'family.total_income'],
            ...
            'orphan_sponsorships' => [
                'filterableAttributes' => ['__soft_deleted', 'id', 'medical_sponsorship', 'orphan.id', 'university_scholarship', 'association_trips', 'summer_camp', 'orphan.academic_achievement.academic_year', 'orphan.academic_achievement.academic_level.id', 'orphan.academic_achievement.last_year_average', 'orphan.gender', 'orphan.birth_date', 'orphan.shoes_size', 'orphan.shirt_size', 'orphan.pants_size',
            ...
            'finances' => [
                'filterableAttributes' => ['__soft_deleted', 'id', 'amount', 'specification', 'creator', 'tenant_id'],
            ...
            'schools' => [
                'filterableAttributes' => ['__soft_deleted', 'id', 'tenant_id', 'quota'],
