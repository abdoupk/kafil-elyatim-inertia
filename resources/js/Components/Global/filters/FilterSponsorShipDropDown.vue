...
defineProps<{ data: { value: string; label: string }[] }>()

const value = defineModel<{ value: string; label: string } | string>('value')
...
<template>
    <listbox v-model="value" as="div">
        <div class="relative mt-2">
            ...
            >
                <span class="ms-3 block truncate">{{ value?.label }}</span>
