...
const save = () => {
    getDataForIndexPages(route('tenant.occasions.monthly-basket.save-to-archive'), params, {
        onStart: () => {
            loading.value = true
        },
        onSuccess: () => {
    ...
    <suspense>
        <div>
            <the-table-header
                ...
                entries="families"
                export-pdf-url="tenant.occasions.monthly-basket.export.pdf"
                export-xlsx-url="tenant.occasions.monthly-basket.export.xlsx"
                filterable
                searchable
