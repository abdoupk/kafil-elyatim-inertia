        ...
        <div class="intro-x box mt-5">
            ...
            <div class="border-t border-slate-200/60 px-5 pb-5">
                <div class="mt-5 flex items-center">
                    <div class="me-3 h-2 w-2 rounded-full bg-pending"></div>
                    <span class="truncate">UI/UX Workshop</span><span class="ms-auto font-medium">23th</span>
                </div>
                <div class="mt-4 flex items-center">
                    <div class="me-3 h-2 w-2 rounded-full bg-primary"></div>
                    <span class="truncate"> VueJs Frontend Development </span
                    ><span class="ms-auto font-medium">10th</span>
                </div>
                <div class="mt-4 flex items-center">
                    <div class="me-3 h-2 w-2 rounded-full bg-warning"></div>
                    <span class="truncate">Laravel Rest API</span><span class="ms-auto font-medium">31th</span>
                </div>
            </div>
        </div>
    </suspense>
