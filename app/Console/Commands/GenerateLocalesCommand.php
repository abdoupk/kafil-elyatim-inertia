...
class GenerateLocalesCommand extends Command
{
    ...
    public function handle(): void
    {
        foreach (Lang::cases() as $lang) {
            $json_file_collection = collect(json_decode(File::get(base_path('lang/'.$lang->value.'.json')), false, 512, JSON_THROW_ON_ERROR));
            ...
            file_put_contents(base_path('public/locales/'.$lang->value.'.json'), json_encode($full_data, JSON_THROW_ON_ERROR | JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT));
        }
    }
}
