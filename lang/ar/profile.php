...
return [
    ...
    'notifications' => [
        ...
        'occasions_saves_description' => 'تلقى إشعارات عند حفظ او تعديل قائمة المستفيدين من بدلة العيد، الأضحية، القفة الشهرية، قفة رمضان، الدخول المدرسي او حفاظات و حليب للأطفال.',
    ],
];
